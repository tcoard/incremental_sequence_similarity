...
time python3 ../../iBLAST/source/iBLAST.py "blastp -db total -query search.fa -outfmt 5 -out result0.xml"

time blastdb_aliastool -dblist "split0.fa split1.fa" -dbtype prot -out total -title "total"
time python3 ../../iBLAST/source/iBLAST.py "blastp -db total -query search.fa -outfmt 5 -out result1.xml"

time blastdb_aliastool -dblist "split0.fa split1.fa split2.fa" -dbtype prot -out total -title "total"
time python3 ../../iBLAST/source/iBLAST.py "blastp -db total -query search.fa -outfmt 5 -out result2.xml"

time blastdb_aliastool -dblist "split0.fa split1.fa split2.fa split3.fa" -dbtype prot -out total -title "total"
time python3 ../../iBLAST/source/iBLAST.py "blastp -db total -query search.fa -outfmt 5 -out result3.xml"

time blastdb_aliastool -dblist "split0.fa split1.fa split2.fa split3.fa split4.fa" -dbtype prot -out total -title "total"
time python3 ../../iBLAST/source/iBLAST.py "blastp -db total -query search.fa -outfmt 5 -out result4.xml"
